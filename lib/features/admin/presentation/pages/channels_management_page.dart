...
class _AdminConsoleChannelsManagementPageState
  ...
  final List<ChannelEntity> _defaultChannels = const [
    ChannelEntity(
      id: 'chn_01',
      name: 'town-square',
      displayName: 'Town Square',
      type: ChannelType.open,
      header: 'General team-wide discussions and announcements',
      totalMsgCount: 1420,
    ),
    ChannelEntity(
      id: 'chn_02',
      ...
      type: ChannelType.open,
      header: 'Non-work conversation and fun',
      totalMsgCount: 890,
    ),
    ChannelEntity(
      id: 'chn_03',
      ...
      header: 'Vulnerability tracking and security posture',
      totalMsgCount: 210,
    ),
    ChannelEntity(
      id: 'chn_04',
      ...
      type: ChannelType.open,
      header: 'CI/CD deployment logs and version release notifications',
      totalMsgCount: 540,
    ),
    ChannelEntity(
      id: 'chn_05',
      ...
      type: ChannelType.open,
      header: 'Figma tokens, Flutter widgets and design guidelines',
      totalMsgCount: 320,
    ),
  ];
  ...
  Future<void> _loadChannels() async {
    ...
    try {
      if (getIt.isRegistered<TeamRepository>() &&
          getIt.isRegistered<ChannelRepository>()) {
        ...
        if (myTeams.isNotEmpty) {
          ...
          for (final team in myTeams.take(3)) {
          ...
          if (loadedList.isNotEmpty) {
            ...
            _channels = List.from(_defaultChannels);
          }
        } else {
          _channels = List.from(_defaultChannels);
        }
