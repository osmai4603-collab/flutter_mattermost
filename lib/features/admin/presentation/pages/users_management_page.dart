...
class _AdminConsoleUsersManagementPageState
  ...
  // القائمة المرجعية المبدئية لحالة عدم الاتصال بالمخدم
  final List<UserEntity> _defaultUsers = const [
    UserEntity(
      id: 'usr_sys_01',
      username: 'sysadmin',
      email: 'admin@mattermost.example',
      firstName: 'System',
      lastName: 'Administrator',
      roles: 'system_admin system_user',
      deleteAt: 0,
      createAt: 1672531200000,
    ),
    UserEntity(
      id: 'usr_sys_02',
      username: 'sarah.connor',
      email: 'sarah.connor@mattermost.example',
      firstName: 'Sarah',
      lastName: 'Connor',
      roles: 'system_user_manager system_user',
      deleteAt: 0,
      createAt: 1680307200000,
    ),
    UserEntity(
      id: 'usr_sys_03',
      username: 'john.doe',
      email: 'john.doe@mattermost.example',
      firstName: 'John',
      lastName: 'Doe',
      roles: 'system_user',
      deleteAt: 0,
      createAt: 1688169600000,
    ),
    UserEntity(
      id: 'usr_sys_04',
      ...
      roles: 'system_guest',
      deleteAt: 0,
      createAt: 1696118400000,
    ),
    UserEntity(
      id: 'usr_sys_05',
      username: 'deactivated.user',
      email: 'deactivated@mattermost.example',
      firstName: 'Former',
      lastName: 'Employee',
      roles: 'system_user',
      deleteAt: 1664582400000,
      createAt: 1664582400000,
    ),
  ];
  ...
  Future<void> _loadUsers() async {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          _users = users.isNotEmpty ? users : List.from(_defaultUsers);
        });
      }
    } catch (e) {
      if (mounted) {
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            _error != null
                                ? 'Offline mode: Showing reference users.'
