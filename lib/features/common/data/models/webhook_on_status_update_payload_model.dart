import 'package:flutter_mattermost/features/common/domain/entities/webhook_on_status_update_payload_entity.dart';

final class WebhookOnStatusUpdatePayloadModel
    extends WebhookOnStatusUpdatePayloadEntity {
  const WebhookOnStatusUpdatePayloadModel({
    super.id,
    super.name,
    super.summary,
    super.is_active,
  ...
  factory WebhookOnStatusUpdatePayloadModel.fromMap(Map<String, dynamic> map) {
    return WebhookOnStatusUpdatePayloadModel(
      id: map["id"] as String?,
  ...
  factory WebhookOnStatusUpdatePayloadModel.fromEntity(
    WebhookOnStatusUpdatePayloadEntity entity,
  ) {
    return WebhookOnStatusUpdatePayloadModel(
      id: entity.id,
      name: entity.name,
  ...
  @override
  WebhookOnStatusUpdatePayloadModel copyWith({
    String? id,
    String? name,
    String? summary,
    bool? is_active,
  ...
  WebhookOnStatusUpdatePayloadEntity toEntity() => WebhookOnStatusUpdatePayloadEntity(
        id: id,
        name: name,
        summary: summary,
        is_active: is_active,
